...
get_battery_combined_percent() {
	...
	# total_charge=$(expr $(acpi -b | grep -Eo "[0-9]+" | paste -sd+ | bc));
...
# xsetroot -name "[ MEMORY $(print_mem)M ] [ DOWN $vel_recv, UP $vel_trans ] [ $(dwm_alsa) ] [ $(print_bat) ]$(show_record) $(print_date) "
xsetroot -name "[ DOWN $vel_recv, UP $vel_trans ] [ $(dwm_alsa) ] [ $(print_bat) ]$(show_record) $(print_date) "
